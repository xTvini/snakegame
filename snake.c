...
{
    system("cls");
    printf("Utilize as setinhas para jogar para movimentar a cobrinha.\n");
    printf("Coma a comida para crescer.\n");
    printf("Cuidado com a colisao no seu proprio corpo e nas paredes.\n");
    printf("sempre que comer uma frutinha seu corpo inverte (a cabeca vira o rabo), fique atento a esse detalhe!!\n");
    getch();
    system("cls");
    generateMenu(2);
}
